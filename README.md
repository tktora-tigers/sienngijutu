...
<body class="min-h-screen pb-16">
  ...
  <header class="bg-white border-b-2 border-slate-200 sticky top-0 z-10 shadow-sm">
    <div class="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
      ...
      <a href="index.html" class="btn-back px-4 py-2 text-slate-700 font-bold text-sm inline-flex items-center gap-2 decoration-none">
  ...
  <main class="max-w-5xl mx-auto px-4 pt-8">
    ...
    <div class="mt-12 text-center">
      <a href="index.html" class="inline-flex items-center gap-2 text-slate-500 hover:text-slate-800 font-bold text-sm underline underline-offset-4 decoration-2 transition-colors">
